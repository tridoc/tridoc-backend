...
| `/raw/tgz` or `/raw/tgz`   | GET    | Get all data. Useful for Backups     | - | Contains blobs/ directory with all pdfs as stored within tridoc and a rdf.ttl file with all metadata. | 1.1.0 |
